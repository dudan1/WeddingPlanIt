<div class="bg-text2">
    <h1>Wedding Plan<font color="red">I</font>t<br/></h1>

    <h2>About Us</h2>
    <p>Wedding PlanIt is the premium wedding planner introduction site, putting you in touch with a variety of relevant
        service providers.</p>
    <hr/>
