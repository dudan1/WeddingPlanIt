...
<!--    <form action="PHP_database_insert?" method="post">-->
    <form id="myform" onsubmit="emailjs.sendForm('Outlook', 'Outlook_Contact_Us', this); return false;" method="post">
        ...
        <button type="button" onclick="location.href='index.html';" class="cancelbtn">Cancel / Return to Welcome Page</button>
    </form>
    ...
    <hr/>
    <p>Or via email:</p>
    <p><a href="mailto:0006664@rgu.ac.uk">Email: WPfake@rgu.ac.uk</a></p>
