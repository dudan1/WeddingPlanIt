    ...
    <div class = grid-container>
        <div class = 'grid-100'>
            <div class ="review-container">
                <?php
                $sql = "select r.review_title, r.review_score , r.review_text, r.review_date, c.first_name, c.surname from reviews r, customer c where c.C_ID = $_SESSION[cust_id] AND c.C_ID = r.C_ID";
